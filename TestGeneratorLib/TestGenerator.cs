    ...
    public static class TestGenerator
    {
        ...
        public static Dictionary<string, string> GenerateTests(FileInfo fileInfo)
        {
            ...
            foreach (var classInfo in fileInfo.Classes)
            {
                ...
                fileNameCode.Add(classInfo.Name + "Test",
        ...
        private static ClassDeclarationSyntax GenerateClass(ClassInfo classInfo)
        {
            ...
            variable = GenerateVariable(GetCheckedClassVariable(classInfo.Name), classInfo.Name);
            fields.Add(GenerateField(variable));
            var methods = new List<MethodDeclarationSyntax>();
            methods.Add(GenerateSetUpMethod(constructor, classInfo.Name));
            foreach (var methodInfo in classInfo.Methods)
            {
                methods.Add(GenerateMethod(methodInfo, classInfo.Name));
            }

            return SyntaxFactory.ClassDeclaration(classInfo.Name + "Test")
        ...
        private static void GenerateAssertPart(List<StatementSyntax> body, string returnType)
        {
            ...
            var secondPart = GenerateExpression("Is", "EqualTo").WithArgumentList(SyntaxFactory.ArgumentList(SyntaxFactory.SeparatedList<ArgumentSyntax>(
